...
create index if not exists ticket_purchase_history_user_idx on public.ticket_purchase_history(app_user_id, created_at desc);
create index if not exists ticket_purchase_history_ticket_idx on public.ticket_purchase_history(ticket_type_id);
