...
export const SERIAL_OVERLAY_TOP_RATIO = 0.16;
export const SERIAL_OVERLAY_MIN_OFFSET_PX = 50;
export const SERIAL_OVERLAY_MAX_OFFSET_PX = 250;
export const SERIAL_OVERLAY_TOP_CSS = "16%";
