  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center px-2 text-center">
        <span className={cn("relative z-10 whitespace-pre-line font-display text-sm font-bold uppercase leading-tight tracking-[0.15em] text-zinc-800 drop-shadow-[0_1px_0_rgba(255,255,255,0.6)]", labelClassName)}>
          {normalizedLabel}
        </span>
        {subLabel ? (
