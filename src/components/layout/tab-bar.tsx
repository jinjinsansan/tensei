...
export function TabBar({ items }: TabBarProps) {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-[calc(1rem+env(safe-area-inset-bottom))] z-50 px-4 pb-[env(safe-area-inset-bottom)] sm:bottom-[calc(1.5rem+env(safe-area-inset-bottom))] md:bottom-[calc(2rem+env(safe-area-inset-bottom))]">
